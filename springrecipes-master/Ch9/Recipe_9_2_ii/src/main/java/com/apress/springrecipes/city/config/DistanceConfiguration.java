...
import com.apress.springrecipes.city.filter.CityServiceRequestFilter;
...
public class DistanceConfiguration {
    ...
    @Bean
    public CityServiceRequestAuditor cityServiceRequestAuditor() {
        return new CityServiceRequestAuditor();
    }

    @Bean
    public CityServiceRequestFilter cityServiceRequestFilter() {
        CityServiceRequestFilter filter = new CityServiceRequestFilter();
        filter.setCityServiceRequestAuditor(cityServiceRequestAuditor());
        return filter;
    }
}
