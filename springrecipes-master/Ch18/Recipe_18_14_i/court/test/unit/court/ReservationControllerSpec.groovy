...
class ReservationControllerSpec extends Specification {
    ...
    def populateValidParams(params) {
        ...
        params["date"] = '2009-10-15 15:00:00.0'
        params["courtName"] = 'Main'
        params["player.id"]= '1'
        params["player.name"] = 'John Doe'
        params["player.phone"] = '0000-0000-0000'
    ...
    void "Test the index action returns the correct model"() {
        ...
        then:"The model is correct"
            !model.reservationInstanceList
            model.reservationInstanceCount == 0
    }
    ...
    void "Test the create action returns the correct model"() {
        ...
        then:"The model is correctly created"
            model.reservationInstance!= null
    }
    ...
    void "Test the save action correctly persists an instance"() {
        ...
        when:"The save action is executed with a valid instance"
            ...
            reservation.validate()
            System.out.println(reservation.errors)
            controller.save(reservation)
    ...
    void "Test that the show action returns the correct model"() {
        ...
        then:"A model is populated containing the domain instance"
            model.reservationInstance == reservation
    }
